...
import (
	...
	"github.com/anyswap/CrossChain-Bridge/tokens/part"
...
func NewCrossChainBridge(id string, isSrc bool) tokens.CrossChainBridge {
	...
	case strings.HasPrefix(blockChainIden, "PARTICL"):
		return part.NewCrossChainBridge(isSrc)
	default:
